...
namespace BachMaiCR.DataAccess.Repository
{
  public class DepartmentRepository : EFRepository<LM_DEPARTMENT>, IDepartmentRepository, IRepository<LM_DEPARTMENT>
  {
    ...
    public bool ExistCode(LM_DEPARTMENT entity)
    {
      ...
      return source.Where(obj => obj.LM_DEPARTMENT_ID != entity.LM_DEPARTMENT_ID).Count() > 0;
    }

    public bool ExistChild(int id)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.DEPARTMENT_PARENT_ID.Value.Equals(id) && (obj.ISDELETE.HasValue.Equals(false) || obj.ISDELETE.Value.Equals(false)))).Count() > 0;
    }

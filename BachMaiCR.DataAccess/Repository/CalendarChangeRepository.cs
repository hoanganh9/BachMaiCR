...
namespace BachMaiCR.DataAccess.Repository
{
  public class CalendarChangeRepository : EFRepository<CALENDAR_CHANGE>, ICalendarChangeRepository, IRepository<CALENDAR_CHANGE>
  {
    ...
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == (int?) idCalendarDuty && obj.STATUS_APPROVED == (int?) statusApproved)).ToList();
    }

    public List<CALENDAR_CHANGE> GetListByDate(int month, int year)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.DATE_START.Value.Month == month && obj.DATE_START.Value.Year == year && obj.STATUS_APPROVED == (int?) 2)).ToList();
    }

    public List<CALENDAR_CHANGE> GetListChangeCalendar(int idCalendarDuty)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == (int?) idCalendarDuty && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).ToList();
    }

    public List<CALENDAR_CHANGE> ListNew(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.TEMPLATE_COLUMN_ID == objCalendarChange.TEMPLATE_COLUMN_ID && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).ToList();
    }
    ...
    public void DeleteCalendarChangeByStatus(int idCalendarDuty, int status)
    {
      ...
      foreach (CALENDAR_CHANGE entity in ((IQueryable<CALENDAR_CHANGE>) calendarChange).Where(predicate).ToList())
        this.Delete(entity);
    }

    public CALENDAR_CHANGE GetInforHospital(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.TEMPLATE_COLUMN_ID == new int?() && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.DOCTORS_CHANGE_ID == objCalendarChange.DOCTORS_CHANGE_ID && obj.DATE_CHANGE_START == objCalendarChange.DATE_CHANGE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).FirstOrDefault();
    }

    public CALENDAR_CHANGE GetChangeByIdDuty(int IdcalendaDuty)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DELETE == (int?) IdcalendaDuty)).FirstOrDefault();
    }

    public CALENDAR_CHANGE GetInfor(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && (objCalendarChange.TEMPLATE_COLUMN_ID == (int?) 0 || obj.TEMPLATE_COLUMN_ID == new int?() || obj.TEMPLATE_COLUMN_ID == objCalendarChange.TEMPLATE_COLUMN_ID) && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).FirstOrDefault();
    }

    public CALENDAR_CHANGE GetInforCh(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.CALENDAR_DELETE == objCalendarChange.CALENDAR_DELETE && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).FirstOrDefault();
    }

    public CALENDAR_CHANGE GetInforDoctorChange(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.DOCTORS_CHANGE_ID == objCalendarChange.DOCTORS_CHANGE_ID && obj.DATE_CHANGE_START == objCalendarChange.DATE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).FirstOrDefault();
    }

    public CALENDAR_CHANGE GetInforDefault(CALENDAR_CHANGE objCalendarChange, int status)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).First();
    }

    public CALENDAR_CHANGE isExistCalendarDuty(CALENDAR_CHANGE objCalendarChange, int status)
    {
      List<CALENDAR_CHANGE> list = this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendarChange.CALENDAR_DUTY_ID && obj.TEMPLATE_COLUMN_ID == objCalendarChange.TEMPLATE_COLUMN_ID && obj.DATE_START == objCalendarChange.DATE_START && obj.DOCTORS_ID == objCalendarChange.DOCTORS_ID && obj.DOCTORS_CHANGE_ID != objCalendarChange.DOCTORS_CHANGE_ID && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).ToList();
    ...
    {
      List<CALENDAR_CHANGE> list = this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DELETE == (int?) idCalendarDuty && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).ToList();
      int num;
    ...
    {
      int num = 0;
      List<CALENDAR_CHANGE> list = this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == (int?) idCalendarDuty && obj.DATE_START.Value.Month == month && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).ToList();
      if (list.Count<CALENDAR_CHANGE>() > 0)
      {
    ...
    public void DeleteCalendarChangeById(int idCalendarDuty)
    {
      ...
      foreach (CALENDAR_CHANGE entity in dbQuery.Where(predicate).ToList())
        this.Delete(entity);
    }

    public bool ExistChangeCaledar(CALENDAR_CHANGE objCalendar, int status = 0)
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == objCalendar.CALENDAR_DUTY_ID && obj.DATE_START == objCalendar.DATE_START && obj.DOCTORS_ID == objCalendar.DOCTORS_ID && obj.DOCTORS_CHANGE_ID == objCalendar.DOCTORS_CHANGE_ID && obj.DATE_CHANGE_START == objCalendar.DATE_CHANGE_START && obj.STATUS == (int?) status && (obj.STATUS_APPROVED == (int?) 1 || obj.STATUS_APPROVED == (int?) 2))).FirstOrDefault() != null;
    }
    ...
    {
      return this.DbSet.AsNoTracking().Where((obj => obj.CALENDAR_DUTY_ID == (int?) idCalendarDuty)).OrderBy<CALENDAR_CHANGE, DateTime?>((Expression<Func<CALENDAR_CHANGE, DateTime?>>) (obj => obj.DATE_START)).ThenBy<CALENDAR_CHANGE, int?>((Expression<Func<CALENDAR_CHANGE, int?>>) (obj => obj.STATUS)).ToList();
    }
  }
}
